...
class TestSaveChart:
    ...
    def test_save_chart_returns_url_and_metadata(self, mock_close, mock_savefig, mock_settings, tmp_path):
        ...
        chart_url, full_metadata = _save_chart(SID, metadata)
...
class TestCreateBarChart:
    ...
    def test_create_bar_chart_success(self, mock_save, sample_dataframe):
        ...
        result = create_bar_chart.invoke({"x_column": "Product", "y_column": "Revenue", "title": "Test Chart"}, CFG)
    ...
    def test_create_bar_chart_no_data(self):
        ...
        result = create_bar_chart.invoke({"x_column": "Product", "y_column": "Revenue"}, CFG)
    ...
    def test_create_bar_chart_invalid_column(self, sample_dataframe):
        ...
        result = create_bar_chart.invoke({"x_column": "Invalid", "y_column": "Revenue"}, CFG)
...
class TestCreateLineChart:
    ...
    def test_create_line_chart_success(self, mock_save, sample_dataframe):
        ...
        result = create_line_chart.invoke({"x_column": "Date", "y_column": "Revenue"}, CFG)
...
class TestCreateDistributionChart:
    ...
    def test_create_distribution_chart_success(self, mock_save, sample_dataframe):
        ...
        result = create_distribution_chart.invoke({"labels_column": "Product", "values_column": "Revenue"}, CFG)
    ...
    def test_create_distribution_chart_limits_to_10(self, mock_save, large_dataframe):
        ...
        result = create_distribution_chart.invoke({"labels_column": "ID", "values_column": "Value"}, CFG)
...
class TestCreateAreaChart:
    ...
    def test_create_area_chart_success(self, mock_save, sample_dataframe):
        ...
        result = create_area_chart.invoke({"x_column": "Date", "y_column": "Revenue"}, CFG)
