 ...
 */
export async function uploadImageToDrive(accessToken, imageBlob, filename = 'chart.png') {
  const metadata = {
    name: filename,
    mimeType: 'image/png'
  }
 ...
 */
export async function addImageToSlide(accessToken, presentationId, slideId, driveFileId) {
 ...
 */
export async function addChartToPresentation(accessToken, presentationId, imageBlob, options = {}) {
